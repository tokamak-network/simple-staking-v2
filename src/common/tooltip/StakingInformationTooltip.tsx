...
export const StakingInformationTooltip = (
	args: StakingInformationTooltipProps,
) => {
	const { title, tooltip, value, unit, widths } = args;
	...
	return (
		...
		>
			...
			>
				<Flex>{value}</Flex>
				<Flex ml={"3px"} fontSize={"13px"} mb={mobile ? "" : "2px"}>
					{unit}
				</Flex>
			</Flex>
		</Flex>
