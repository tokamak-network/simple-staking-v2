	...
	return (
		...
		>
			<Flex
				flexDir={"row"}
				justifyContent={
					tableType === "Update Seigniorage" && columnName === "Time"
						? "start"
						: "center"
				}
			>
				{tableType === "Transactions" && columnName === "Account" ? (
					...
					"Update #"
				) : tableType === "Transactions" && columnName === "Type" ? (
					<TypeItem />
				) : tableType === "Transactions" && columnName === "Amount" ? (
					"Amount"
				) : tableType === "Update Seigniorage" && columnName === "Time" ? (
					"Last update"
				) : tableType === "Transactions" && columnName === "Time" ? (
					"Status"
				) : (
					""
				)}
...
const typeItemList = ["All", "Stake", "Unstake", "Withdraw"];
