	...
	return (
		<div>
			<Head>
				...
				<meta
					property="og:url"
					content="https://simple.staking.tokamak.network"
				/>
				<meta property="title" content="Simple Staking - Tokamak" />
				<meta property="og:title" content="Simple Staking - Tokamak" />
				<meta property="description" content="Easier UI for Tokamak Staking" />
				<meta
				...
				<script
					async
					src="https://www.googletagmanager.com/gtag/js?id=G-E0YQDXW30R"
				></script>
				<script>
