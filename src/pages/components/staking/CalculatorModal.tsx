...
function CalculatorModal() {
	...
	const calButton = useCallback(async () => {
		...
		if (Staked && selectedModalData) {
			...
			const rewardUSD = (expectedSeig * tonPriceUSD).toLocaleString(undefined, {
				maximumFractionDigits: 2,
			});
			const rewardKRW = (expectedSeig * tonPriceKRW).toLocaleString(undefined, {
			...
			setROI(rate.toLocaleString(undefined, { maximumFractionDigits: 2 }));
			setType("result");
		}
