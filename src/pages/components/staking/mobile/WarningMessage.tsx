		...
		<Flex>
			...
			title === "Restake" ? (
				...
				>
					...
					: Restaking will stake unstaked TON, and these cannot be withdrawn
					until they are unstaked again.
				</Text>
			) : title === "Unstake" ? (
				<Text
					fontSize={"12px"}
				...
				>
					...
					: You can withdraw (W)TON to your wallet after 93,046 blocks (~14
					days) from unstaking. Remember to claim any unclaimed staking reward
					before unstaking.
				</Text>
			) : (
				""
