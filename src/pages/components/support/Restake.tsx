			...
			<OrderedList>
				<ListItem color={"black.100"}>
					<Text {...theme.SUPPORT_PARAGRAPH_STYLE.paragraphText()}>
						Press the <span style={{ fontWeight: "bold" }}>Restake</span> button
						and a popup will appear.
					</Text>
				</ListItem>
				<ListItem color={"black.100"}>
					<Text {...theme.SUPPORT_PARAGRAPH_STYLE.paragraphText()}>
						Click the <span style={{ fontWeight: "bold" }}>Restake</span> button
						to Restake all your re-stakable TON at once.
					</Text>
				</ListItem>
				<ListItem color={"black.100"}>
					<Text {...theme.SUPPORT_PARAGRAPH_STYLE.paragraphText()}>
