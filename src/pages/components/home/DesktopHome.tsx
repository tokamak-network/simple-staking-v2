  ...
  return (
    <Box w={'100%'} mt={'36px'}>
      ...
      >
        ...
        <Flex position={'absolute'} flexDir={'column'} alignItems={'center'} width={'100%'}>
          ...
          <Text h={'48px'} color={'#3d495d'} mt={'25px'} fontFamily={theme.fonts.TitilliumWeb}>
            Staked in the
          </Text>
          <Text h={'42px'} mt={'20px'} fontSize={'38px'} fontFamily={theme.fonts.Nanum}>
            Tokamak Network
          </Text>
          <Flex flexDir={'column'} mt="30px">
            <Flex alignItems={'center'}>
              <Flex h="2px" w="15px" bg={'blue.200'} mr="10px" />
              <Text color={'gray.500'} mr="20px" fontSize="13px" fontFamily={theme.fonts.TitilliumWeb}>
                {' '}
                Total Stake
              </Text>
